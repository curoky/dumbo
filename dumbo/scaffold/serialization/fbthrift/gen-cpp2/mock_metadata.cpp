...
void EnumMetadata<::idl::thrift::cpp2::EnumType>::gen(ThriftMetadata& metadata) {
  auto res =
      metadata.enums_ref()->emplace("mock.EnumType", ::apache::thrift::metadata::ThriftEnum{});
  if (!res.second) {
    return;
  }
  ...
  for (std::size_t i = 0; i < EnumTraits::size; ++i) {
    enum_metadata.elements_ref()->emplace(static_cast<int32_t>(EnumTraits::values[i]),
                                          EnumTraits::names[i].str());
  }
}

const ::apache::thrift::metadata::ThriftStruct& StructMetadata<::idl::thrift::cpp2::UnionType>::gen(
    ThriftMetadata& metadata) {
  auto res =
      metadata.structs_ref()->emplace("mock.UnionType", ::apache::thrift::metadata::ThriftStruct{});
  if (!res.second) {
  ...
  static const std::tuple<int32_t, const char*, bool, std::unique_ptr<MetadataTypeInterface>>
      mock_UnionType_fields[] = {
          std::make_tuple(1, "var_i16", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_I16_TYPE)),
          std::make_tuple(2, "var_i32", false,
...
StructMetadata<::idl::thrift::cpp2::MockRequest>::gen(ThriftMetadata& metadata) {
  auto res = metadata.structs_ref()->emplace("mock.MockRequest",
  ...
  static const std::tuple<int32_t, const char*, bool, std::unique_ptr<MetadataTypeInterface>>
      mock_MockRequest_fields[] = {
          std::make_tuple(1, "var_bool", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_BOOL_TYPE)),
          std::make_tuple(2, "var_byte", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_BYTE_TYPE)),
          std::make_tuple(3, "var_i16", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_I16_TYPE)),
          std::make_tuple(4, "var_i32", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_I32_TYPE)),
          std::make_tuple(5, "var_i64", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_I64_TYPE)),
          std::make_tuple(6, "var_double", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_DOUBLE_TYPE)),
          std::make_tuple(7, "var_string", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_STRING_TYPE)),
          std::make_tuple(8, "var_binary", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_BINARY_TYPE)),
          std::make_tuple(9, "var_string_type", false,
                          std::make_unique<Typedef>("mock.StrType",
                                                    std::make_unique<Primitive>(
                                                        ThriftPrimitiveType::THRIFT_STRING_TYPE))),
          std::make_tuple(10, "var_string_list", false,
                          std::make_unique<List>(std::make_unique<Primitive>(
                              ThriftPrimitiveType::THRIFT_STRING_TYPE))),
          std::make_tuple(11, "var_binary_list", false,
                          std::make_unique<List>(std::make_unique<Primitive>(
                              ThriftPrimitiveType::THRIFT_BINARY_TYPE))),
          std::make_tuple(12, "var_string_set", false,
                          std::make_unique<Set>(std::make_unique<Primitive>(
                              ThriftPrimitiveType::THRIFT_STRING_TYPE))),
          std::make_tuple(
              13, "var_string_binary_map", false,
              std::make_unique<Map>(
                  std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_STRING_TYPE),
                  std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_BINARY_TYPE))),
          std::make_tuple(14, "var_enum", false,
                          std::make_unique<Enum<::idl::thrift::cpp2::EnumType>>("mock.EnumType")),
          std::make_tuple(
              15, "var_enum_set", false,
              std::make_unique<Set>(
                  std::make_unique<Enum<::idl::thrift::cpp2::EnumType>>("mock.EnumType"))),
          std::make_tuple(
              16, "var_union", false,
              std::make_unique<Union<::idl::thrift::cpp2::UnionType>>("mock.UnionType")),
          std::make_tuple(17, "var_required_i32", false,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_I32_TYPE)),
          std::make_tuple(18, "var_optional_i32", true,
                          std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_I32_TYPE)),
      };
...
StructMetadata<::idl::thrift::cpp2::MockResponse>::gen(ThriftMetadata& metadata) {
  auto res = metadata.structs_ref()->emplace("mock.MockResponse",
                                             ::apache::thrift::metadata::ThriftStruct{});
  if (!res.second) {
    return res.first->second;
  }
  ...
  static const std::tuple<int32_t, const char*, bool, std::unique_ptr<MetadataTypeInterface>>
      mock_MockResponse_fields[] = {
          std::make_tuple(
              1, "req", false,
              std::make_unique<Struct<::idl::thrift::cpp2::MockRequest>>("mock.MockRequest")),
      };
...
StructMetadata<::idl::thrift::cpp2::MockException>::gen(ThriftMetadata& metadata) {
  auto res = metadata.structs_ref()->emplace("mock.MockException",
                                             ::apache::thrift::metadata::ThriftStruct{});
  if (!res.second) {
    return res.first->second;
  }
...
void ExceptionMetadata<::idl::thrift::cpp2::MockException>::gen(ThriftMetadata& metadata) {
  auto res = metadata.exceptions_ref()->emplace("mock.MockException",
                                                ::apache::thrift::metadata::ThriftException{});
  if (!res.second) {
    return;
  }
...
void ServiceMetadata<::idl::thrift::cpp2::EchoServiceSvIf>::gen_echo(ThriftMetadata& metadata,
                                                                     ThriftService& service) {
  ::apache::thrift::metadata::ThriftFunction func;
  (void)metadata;
  func.name_ref() = "echo";
  auto func_ret_type =
      std::make_unique<Struct<::idl::thrift::cpp2::MockResponse>>("mock.MockResponse");
  ...
  auto mock_EchoService_echo_req_1_type =
      std::make_unique<Struct<::idl::thrift::cpp2::MockRequest>>("mock.MockRequest");
  mock_EchoService_echo_req_1_type->writeAndGenType(*mock_EchoService_echo_req_1.type_ref(),
                                                    metadata);
  ...
  auto mock_EchoService_echo_ex_1_type =
      std::make_unique<Struct<::idl::thrift::cpp2::MockException>>("mock.MockException");
  mock_EchoService_echo_ex_1_type->writeAndGenType(*mock_EchoService_echo_ex_1.type_ref(),
                                                   metadata);
...
void ServiceMetadata<::idl::thrift::cpp2::EchoServiceSvIf>::gen_oneway_echo(
  ...
  auto mock_EchoService_oneway_echo_req_1_type =
      std::make_unique<Struct<::idl::thrift::cpp2::MockRequest>>("mock.MockRequest");
  mock_EchoService_oneway_echo_req_1_type->writeAndGenType(
      *mock_EchoService_oneway_echo_req_1.type_ref(), metadata);
  func.arguments_ref()->push_back(std::move(mock_EchoService_oneway_echo_req_1));
  func.is_oneway_ref() = true;
  service.functions_ref()->push_back(std::move(func));
}

void ServiceMetadata<::idl::thrift::cpp2::EchoServiceSvIf>::gen(ThriftMetadata& metadata,
                                                                ThriftServiceContext& context) {
  (void)metadata;
