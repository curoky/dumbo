...
int _kEnumTypeValues[] = {
  EnumType::ZERO,
  EnumType::ONE,
  EnumType::TWO,
  EnumType::THREE
};
const char* _kEnumTypeNames[] = {
  "ZERO",
  "ONE",
  "TWO",
  "THREE"
};
const std::map<int, const char*> _EnumType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kEnumTypeValues, _kEnumTypeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
void UnionType::printTo(std::ostream& out) const {
  ...
  out << "UnionType(";
  out << "var_i16="; (__isset.var_i16 ? (out << to_string(var_i16)) : (out << "<null>"));
  out << ", " << "var_i32="; (__isset.var_i32 ? (out << to_string(var_i32)) : (out << "<null>"));
  out << ")";
}
...
void MockRequest::__set_var_bool(const bool val) {
  this->var_bool = val;
}

void MockRequest::__set_var_byte(const int8_t val) {
  this->var_byte = val;
}

void MockRequest::__set_var_i16(const int16_t val) {
  this->var_i16 = val;
}

void MockRequest::__set_var_i32(const int32_t val) {
  this->var_i32 = val;
}

void MockRequest::__set_var_i64(const int64_t val) {
  this->var_i64 = val;
}

void MockRequest::__set_var_double(const double val) {
  this->var_double = val;
}

void MockRequest::__set_var_string(const std::string& val) {
  this->var_string = val;
}

void MockRequest::__set_var_binary(const std::string& val) {
  this->var_binary = val;
}

void MockRequest::__set_var_string_type(const StrType& val) {
  this->var_string_type = val;
}
...
void MockRequest::__set_var_enum(const EnumType::type val) {
  this->var_enum = val;
}
...
void MockRequest::__set_var_union(const UnionType& val) {
  this->var_union = val;
}

void MockRequest::__set_var_required_i32(const int32_t val) {
  this->var_required_i32 = val;
}
...
uint32_t MockRequest::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->var_string_list.size()));
    std::vector<std::string> ::const_iterator _iter33;
    for (_iter33 = this->var_string_list.begin(); _iter33 != this->var_string_list.end(); ++_iter33)
    {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->var_binary_list.size()));
    std::vector<std::string> ::const_iterator _iter34;
    for (_iter34 = this->var_binary_list.begin(); _iter34 != this->var_binary_list.end(); ++_iter34)
    {
  ...
  {
    xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->var_string_set.size()));
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->var_string_binary_map.size()));
    std::map<std::string, std::string> ::const_iterator _iter36;
    for (_iter36 = this->var_string_binary_map.begin(); _iter36 != this->var_string_binary_map.end(); ++_iter36)
    {
  ...
  {
    xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->var_enum_set.size()));
...
void MockRequest::printTo(std::ostream& out) const {
  ...
  out << ", " << "var_byte=" << to_string(var_byte);
  out << ", " << "var_i16=" << to_string(var_i16);
  out << ", " << "var_i32=" << to_string(var_i32);
  out << ", " << "var_i64=" << to_string(var_i64);
  out << ", " << "var_double=" << to_string(var_double);
  out << ", " << "var_string=" << to_string(var_string);
  out << ", " << "var_binary=" << to_string(var_binary);
  out << ", " << "var_string_type=" << to_string(var_string_type);
  out << ", " << "var_string_list=" << to_string(var_string_list);
  out << ", " << "var_binary_list=" << to_string(var_binary_list);
  out << ", " << "var_string_set=" << to_string(var_string_set);
  out << ", " << "var_string_binary_map=" << to_string(var_string_binary_map);
  out << ", " << "var_enum=" << to_string(var_enum);
  out << ", " << "var_enum_set=" << to_string(var_enum_set);
  out << ", " << "var_union=" << to_string(var_union);
  out << ", " << "var_required_i32=" << to_string(var_required_i32);
  out << ", " << "var_optional_i32="; (__isset.var_optional_i32 ? (out << to_string(var_optional_i32)) : (out << "<null>"));
  out << ")";
}
...
void MockResponse::__set_req(const MockRequest& val) {
  this->req = val;
}
...
void MockException::__set_msg(const std::string& val) {
  this->msg = val;
}
