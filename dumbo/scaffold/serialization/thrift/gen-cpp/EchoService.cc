...
void EchoServiceClient::oneway_echo(const MockRequest& req)
{
  send_oneway_echo(req);
}
...
void EchoServiceProcessor::process_oneway_echo(int32_t, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol*, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("EchoService.oneway_echo", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "EchoService.oneway_echo");
...
void EchoServiceConcurrentClient::oneway_echo(const MockRequest& req)
{
  send_oneway_echo(req);
}
