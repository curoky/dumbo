...
typedef struct _MockRequest__isset {
  _MockRequest__isset() : var_bool(false), var_byte(false), var_i16(false), var_i32(false), var_i64(false), var_double(false), var_string(false), var_binary(false), var_string_type(false), var_string_list(false), var_binary_list(false), var_string_set(false), var_string_binary_map(false), var_enum(false), var_enum_set(false), var_union(false), var_optional_i32(false) {}
  bool var_bool :1;
  bool var_byte :1;
  bool var_i16 :1;
  bool var_i32 :1;
...
class MockRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  MockRequest() : var_bool(0), var_byte(0), var_i16(0), var_i32(0), var_i64(0), var_double(0), var_string(), var_binary(), var_string_type(), var_enum((EnumType::type)0), var_required_i32(0), var_optional_i32(0) {
  }
  ...
  {
    if (!(var_bool == rhs.var_bool))
      return false;
    if (!(var_byte == rhs.var_byte))
      return false;
    if (!(var_i16 == rhs.var_i16))
      return false;
    if (!(var_i32 == rhs.var_i32))
      return false;
    if (!(var_i64 == rhs.var_i64))
      return false;
    if (!(var_double == rhs.var_double))
      return false;
    if (!(var_string == rhs.var_string))
      return false;
    if (!(var_binary == rhs.var_binary))
      return false;
    if (!(var_string_type == rhs.var_string_type))
      return false;
    if (!(var_string_list == rhs.var_string_list))
      return false;
    if (!(var_binary_list == rhs.var_binary_list))
      return false;
    if (!(var_string_set == rhs.var_string_set))
      return false;
    if (!(var_string_binary_map == rhs.var_string_binary_map))
      return false;
    if (!(var_enum == rhs.var_enum))
      return false;
    if (!(var_enum_set == rhs.var_enum_set))
      return false;
    if (!(var_union == rhs.var_union))
      return false;
    if (!(var_required_i32 == rhs.var_required_i32))
      return false;
