...
#include <fatal/test/type.h>                 // for type_str
#include <fatal/type/apply.h>                // for applier, apply_to, curry
#include <fatal/type/array.h>                // for z_data
#include <fatal/type/call_traits.h>          // for FATAL_CALL_TRAITS
#include <fatal/type/cat.h>                  // for cat
#include <fatal/type/compare.h>              // for less, sequence_compare
#include <fatal/type/find.h>                 // for find
#include <fatal/type/foreach.h>              // for foreach
#include <fatal/type/get.h>                  // for get
#include <fatal/type/get_type.h>             // for name, type, verb, result
#include <fatal/type/list.h>                 // for list
#include <fatal/type/sequence.h>             // for FATAL_S, index_sequence, make_index_sequence
#include <fatal/type/size.h>                 // for size
#include <fatal/type/slice.h>                // for at
#include <fatal/type/sort.h>                 // for reject, sort
#include <fatal/type/tag.h>                  // for tag, not_found
#include <fatal/type/transform.h>            // for transform
#include <fatal/type/trie.h>                 // for trie_find
